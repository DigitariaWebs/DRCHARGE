...
export const BADGE_STYLES = {
  ...
  accent: 'bg-accent/10 border border-accent/20 text-accent shadow-lg shadow-accent/5',
  primary: 'bg-primary/10 border border-primary/20 text-primary shadow-lg shadow-primary/5',
...
export const BUTTON_STYLES = {
  primary: 'px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300',
  secondary: 'px-8 py-6 text-lg font-semibold rounded-xl transition-all duration-300',
  large: 'px-10 py-7 text-lg font-semibold rounded-xl transition-all duration-300',
  xlarge: 'px-12 py-8 text-xl font-semibold rounded-2xl transition-all duration-300',
  magnetic: 'relative overflow-hidden transition-all duration-300 hover:scale-105',
} as const;
...
export const CARD_STYLES = {
  ...
  light: 'bg-white/80 backdrop-blur-sm border border-border/50 hover:bg-white hover:border-accent/30 hover:shadow-2xl hover:shadow-accent/10 hover:-translate-y-2',
  ...
  glass: 'bg-white/70 backdrop-blur-md border border-white/20 hover:bg-white/80',
  interactive: 'bg-white/90 backdrop-blur-sm border border-border/50 hover:border-accent/40 hover:shadow-2xl hover:shadow-accent/15 hover:-translate-y-3 transition-all duration-500 cursor-pointer',
  elevated: 'bg-white shadow-xl shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:shadow-accent/20 hover:-translate-y-2',
} as const;
...
export const IMAGE_STYLES = {
  ...
  hoverLarge: 'group-hover:scale-110 transition-transform duration-1000 ease-out',
...
export const GRADIENT_OVERLAYS = {
  radialPrimary: 'bg-[radial-gradient(circle_at_50%_50%,rgba(37,99,235,0.08),transparent_50%)]',
  radialAccent: 'bg-[radial-gradient(circle_at_50%_50%,rgba(5,150,105,0.1),transparent_50%)]',
  radialAccentStrong: 'bg-[radial-gradient(circle_at_50%_50%,rgba(5,150,105,0.2),transparent_70%)]',
  radialTech: 'bg-[radial-gradient(circle_at_50%_50%,rgba(37,99,235,0.15),transparent_60%)]',
  radialEco: 'bg-[radial-gradient(ellipse_at_top,rgba(16,185,129,0.1),transparent_50%)]',
  meshGradient: 'bg-[radial-gradient(at_top_left,rgba(5,150,105,0.15),transparent_50%),radial-gradient(at_top_right,rgba(37,99,235,0.15),transparent_50%),radial-gradient(at_bottom,rgba(16,185,129,0.1),transparent_50%)]',
} as const;
