        ...
        <div className="flex flex-col min-h-screen">
                ...
                <div className="container relative z-10 px-4 md:px-6 text-center text-white">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-4 justify-center pt-8">
                            <Button size="lg" className="text-lg px-8" onClick={() => router.push(`/${lang}/contact`)}>
                                {dictionary.hero.cta_primary}
                            </Button>
                            <Button size="lg" variant="outline" className="text-lg px-8 bg-white/10 border-white/20 hover:bg-white/20 text-white" onClick={() => router.push(`/${lang}/about`)}>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-300 leading-relaxed">
                                Ne laissez pas une batterie vide gâcher votre journée.
                                Avec le réseau Dr. Charge, l'énergie est toujours à portée de main.
                            </p>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-background">
                <div className="container px-4 md:px-6">
                    ...
                    >
                        {[
                            { icon: Zap, title: dictionary.services.items.station.title, desc: "Ultra-fast charging up to 100W." },
                            { icon: Shield, title: "Sécurité Maximale", desc: "Protection avancée pour vos appareils." }, // Todo: add to dictionary
                            { icon: Leaf, title: "Durable", desc: "Écosystème énergétique vert et responsable." }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                                variants={fadeInUp}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <ul className="space-y-4">
                                {["Recharge 25% en 15 min", "Compatible Tous Appareils", "Écran Tactile HD"].map((feat, i) => (
                                    <motion.li key={i} className="flex items-center gap-3 text-lg font-medium"
                                        initial={{ opacity: 0, x: 20 }}
                                        whileInView={{ opacity: 1, x: 0 }}
                            ...
                            <Button size="lg" className="mt-4" onClick={() => router.push(`/${lang}/services`)}>
                                {dictionary.common.view_all} <ArrowRight className="ml-2 h-4 w-4" />
                            </Button>
                        </motion.div>
                    </div>
                </div>
            ...
            <section ref={targetRef} className="py-24 min-h-[80vh] flex items-center relative overflow-hidden">
                <motion.div
                    style={{ scale, opacity }}
                ...
                <div className="container relative z-10 px-4 md:px-6 text-white text-center">
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h2 className="text-5xl md:text-7xl font-bold mb-6">{dictionary.services.items.truck.title}</h2>
                        <p className="text-xl max-w-2xl mx-auto mb-10">{dictionary.services.items.truck.description}</p>
                        <Button size="lg" variant="default" className="text-lg h-14 px-10" onClick={() => router.push(`/${lang}/contact`)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/20">
                        {[
                            ...
                            <motion.div
                                ...
                                className="p-6"
                            >
                                <div className="text-5xl md:text-6xl font-black mb-2 tracking-tighter">{stat.val}</div>
