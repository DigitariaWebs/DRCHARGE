    ...
    return (
        <div className="pt-24 pb-16">
            <div className="container px-4 md:px-6">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-bold mb-6">{dictionary.about.title}</h1>
                    <p className="text-xl text-muted-foreground mb-12">{dictionary.about.mission}</p>
                    ...
                    <div className="relative w-full h-[300px] md:h-[500px] rounded-3xl overflow-hidden mb-16 shadow-2xl">
                        ...
                        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                            <h3 className="text-white text-3xl font-bold">Énergie Verte & Durable</h3>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
                    <div className="space-y-6">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                            Nos unités mobiles et stations sont conçues par les meilleurs ingénieurs pour allier esthétique et performance.
                            Le design du camion mobile permet une intervention rapide et efficace partout.
                        </p>
                    </div>
